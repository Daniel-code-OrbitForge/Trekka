...
import logger from "../utils/logger.js"; // Make sure logger.js also uses export default
 ...
 */
export async function generateBookingQR(bookingReference) {
  try {
 ...
 */
export async function sendPaymentReceipt(paymentData, bookingData) {
  try {
    const emailContent = `
      ...
      <div style="background: #f9f9f9; padding: 15px; border-radius: 5px; margin: 20px 0;">
        ...
        <p><strong>Amount Paid:</strong> ${paymentData.currency} ${(
 ...
 * @param {Object} bookingData - Booking details
 */
export async function sendBookingPass(bookingData) {
  try {
...
// Optional helper for other generic emails
